...
def _add_species_records(document: Document, county: dict):
    ...
    for record in sorted_records:
        ...
        if record["observation"].get("subId"):
            _add_species_link(document, record)


def _add_species_heading(document: Document, species: str, record: dict, county: dict):
    ...
    if unique_exclude_notes := record["review_species"].get("uniqueExcludeNotes", None):
...
def _add_species_link(document: Document, record: dict):
